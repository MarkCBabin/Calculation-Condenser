...
f1.write(titlebox+titlebox+'\t\t\t\tUsing G16OC Version 2.5\n\t\t\tThis section is for ')
f1.write(str(inFile))
...
# if wavefunction method; harder to report energy
	...
	# cleans up the output of the list comprehension so that the output is v readable!
